...
# Matriz del sistema
A = np.array([[-(k + k_c) / m, k_c / m], [k_c / m, -(k + k_c) / m]])
...
fig.suptitle("Comparación: Sistema Lineal vs No Lineal", fontsize=16, fontweight="bold")

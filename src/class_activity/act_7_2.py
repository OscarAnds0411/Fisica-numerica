...
)  # intervalo de tiempo entre fotogramas
...
ani = anim.FuncAnimation(
    fig, func=animate, frames=range(tsteps), interval=1000 * dt, blit=True
)  # creamos la animacion
# Descomente para guardar como archivo de pelicula mp4. Necesita ffmpeg.
# ani.save('wavepacket.mp4', writer='ffmpeg', fps=30, dpi=150)
# ani.save('wavepacket.gif', writer='pillow', fps=30, dpi=200)
ani.save("wavepacket.mp4", writer="imagemagick", fps=30)

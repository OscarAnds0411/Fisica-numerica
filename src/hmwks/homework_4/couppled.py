...
m = [1., 2.,0.5] # masa de los bloques la de 2. va con [4] y la de 0.5 con [5]
k = [12., 10., 8.,15., 10., 20.] #constante de los resortes externos
k_c = [4.0, 2., 12.,5.,4., 8.] #constante del resorte central
...
# Matriz del sistema
A = array([[-(k[1] + k_c[3])/m[0], k_c[3]/m[0]],
              [k_c[3]/m[0], -(k[1] + k_c[3])/m[0]]])
